export const CASES = [
...

  {
    ...
    clues: [
      ...
      { id: 'c2', title: 'دليل الرعب الصامت', text: 'لو ضاع منك في البيت على الوضع الصامت، بتعيش لحظات رعب حقيقية.', difficulty: 'easy', category: 'مواقف يومية', location_id: 'loc-living' },
      { id: 'c3', title: 'دليل الشاحن', text: 'الشاحن بتاعه بقى أهم من الأكل والشرب بالنسبة لناس كتير.', difficulty: 'easy', category: 'تكنولوجيا', location_id: 'loc-living' },
      { id: 'c4', title: 'دليل الشاشة المكسورة', text: 'لو الشاشة بتاعته اتكسرت، بتحس إن جزء من روحك هو اللي اتكسر.', difficulty: 'medium', category: 'مواقف مضحكة', location_id: 'loc-work', requires_puzzle: true, puzzle_id: 'puz-phone-1' },
      { id: 'c5', title: 'دليل الفيشة', text: 'المكان اللي بتقعد فيه جنب الفيشة بقى هو المكان المفضل في البيت.', difficulty: 'medium', category: 'عادات شعبية', location_id: 'loc-living' },
      { id: 'c6', title: 'دليل الأسرار والتوتر', text: 'بنسجل عليه كل أسرارنا وصورنا، ولو حد مسكه مفتوح بنتوتر فوراً.', difficulty: 'medium', category: 'أسرار وحكايات', location_id: 'loc-bedroom' },
  ...
  },
  {
    ...
    clues: [
      ...
      { id: 'c2', title: 'دليل تداول الأجرة', text: 'بتعدّي الفلوس للمحطة وتستنى الباقي يرجعلك من إيد لإيد.', difficulty: 'easy', category: 'مواقف شعبية', location_id: 'loc-driver-side' },
      { id: 'c3', title: 'دليل الأغاني والمهرجانات', text: 'أوقات بتسمع فيها أحدث أغاني التوك توك والمهرجانات بأعلى صوت.', difficulty: 'easy', category: 'ثقافة مصرية', location_id: 'loc-station' },
      { id: 'c4', title: 'دليل كرسي الأجرة', text: 'الكرسي اللي ورا السواق دايماً بيبقى صاحب المسؤولية الكبرى في جمع الأجرة.', difficulty: 'medium', category: 'مواقف مضحكة', location_id: 'loc-driver-side' },
      { id: 'c5', title: 'دليل ساعة الذروة', text: 'لو نزلت في ساعة الذروة، بتكتشف قدرات خارقة عندك في التزاحم والدخول.', difficulty: 'medium', category: 'روتين يومي', location_id: 'loc-station' },
      { id: 'c6', title: 'دليل حكايات الغرباء', text: 'ممكن تسمع فيها قصة حياة الشخص اللي قاعد جنبك من غير ما تسأله.', difficulty: 'medium', category: 'فضول واجتماعيات', location_id: 'loc-last-seat' },
  ...
  },
  {
    ...
    clues: [
      ...
      { id: 'c2', title: 'دليل الصان بلوك', text: 'الشمس، البحر، والمايوه، مع ريحة صان بلوك في كل مكان.', difficulty: 'easy', category: 'أجواء صيفية', location_id: 'loc-beach' },
      { id: 'c3', title: 'دليل المصاريف الصاروخية', text: 'المصاريف فيه بتطير بسرعة الصاروخ، وتراجع حساباتك البنكية بعد ما ترجع.', difficulty: 'medium', category: 'مواقف مضحكة', location_id: 'loc-walk' },
      { id: 'c4', title: 'دليل تقسيم الصيف', text: 'تقسيمة شائعة بين الناس: يا إما طيب وأليف، يا إما شقاوة وزحمة ومحلات غالية.', difficulty: 'medium', category: 'تصنيفات مصرية', location_id: 'loc-walk' },
      { id: 'c5', title: 'دليل الجروب الملغي', text: 'السفرية دي بتتخطط في الجروب من 3 شهور، وفي الآخر نص الفريق بيلغي.', difficulty: 'medium', category: 'صحاب وإجازات', location_id: 'loc-hotel' },
      { id: 'c6', title: 'دليل إجازة التعافي', text: 'الرجوع منه بيبقى محتاج إجازة ثانية عشان تظبط نومتك وتتعافى من التعب.', difficulty: 'hard', category: 'روتين الصيف', location_id: 'loc-hotel' },
